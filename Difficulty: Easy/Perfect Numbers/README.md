<h2><a href="https://www.geeksforgeeks.org/problems/perfect-numbers3207/1?page=3&difficulty=Basic,Easy&status=unsolved&sortBy=submissions">Perfect Numbers</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a number <strong>n,</strong> check if a number is perfect or not. A number is said to be perfect if sum of all its factors excluding the number itself is equal to the number.&nbsp;</span></p>
